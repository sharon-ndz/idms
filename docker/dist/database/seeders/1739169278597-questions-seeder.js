...
exports.QuestionsSeeder1739169278597 = void 0;
const question_entity_1 = require("../../entities/question.entity");
const aws_s3_1 = __importDefault(require("../../core/helpers/aws.s3"));
class QuestionsSeeder1739169278597 {
    constructor() {
        this.track = false;
    }
    async run(dataSource, factoryManager) {
        const questionRepository = dataSource.getRepository(question_entity_1.Question);
        const questions = [
            {
            ...
            {
                questionText: 'Traction is important to car control. Which of the following types of traction is most dangerous?',
                options: [
            ...
            {
                questionText: 'To pass a slower-moving vehicle on a two-lane road you must do all this except',
                options: [
            ...
            {
                questionText: 'If a vehicle using high beams comes towards you, you should look towards_____ of the road',
                options: [
            ...
            {
                questionText: 'Being overconfident can affect the performance of the driver and lead to an accident',
                options: [
                    { id: 'A', text: 'True' },
                    { id: 'B', text: 'False' },
                ],
            ...
            {
                questionText: 'You were driving, when you got to a junction, you found a stop sign with a solid white line on the road surface as seen in the image below. Why is there a stop sign at the junction?',
            ...
            {
                questionText: 'You are driving through a road, and all of a sudden you see the road sign below. What does this sign mean?',
            ...
            {
                questionText: 'The line drawn on the road as a result of emergency application of break is called?',
                options: [
            ...
            {
                questionText: 'What is the last group in the list of driving license categories in Nigeria?',
                options: [
                    { id: 'A', text: 'Group Z' },
                    { id: 'B', text: 'Group V' },
                    { id: 'C', text: 'Group J' },
            ...
            {
                questionText: 'There is a rule you need to take as to easily know if you are maintaining a safe driving distance. What is this rule called?',
                options: [
            ...
            {
                questionText: 'At which of the traffic signals below may you move on if you are in the left-hand lane at traffic signals and you are waiting to turn left?',
            ...
            {
                questionText: 'When near a pedestrian crossing,as the pedestrians are waiting to cross the road, what should you do?',
                options: [
            ...
            {
                questionText: 'A person driving a vehicle in a public place without a license is liable for:',
                options: [
            ...
            {
                questionText: 'While parking your vehicle on a downward gradient, in addition to the application of hand brake, the gear engaged should be:',
                options: [
            ...
            {
                questionText: 'When a vehicle is involved in an accident causing injury to any person. What should you do?',
                options: [
                    {
                        id: 'A',
            ...
            {
                questionText: 'When a blind person is crossing the road, holding a white cane, the driver should:',
                options: [
            ...
            {
                questionText: 'When you reach an intersection where there is no signal light or a traffic policeman you should:',
                options: [
            ...
            {
                questionText: 'Where is the number of passengers permitted to be taken in a private vehicle recorded?',
                options: [
        ...
        for (const question of questions) {
            if (question.questionImage) {
                ...
                const base64 = await awsS3bucket.localFileToBase64(imagePath);
                if (base64) {
...
exports.QuestionsSeeder1739169278597 = QuestionsSeeder1739169278597;
//# sourceMappingURL=1739169278597-questions-seeder.js.map